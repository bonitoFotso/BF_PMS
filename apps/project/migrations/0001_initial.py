    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_debut', models.DateField(blank=True, verbose_name='date de debut')),
                ('date_fin', models.DateField(blank=True, verbose_name='date de fin')),
                ('createdAt', models.DateTimeField(auto_now_add=True)),
                ('updatedAt', models.DateTimeField(auto_now=True)),
                ('agence', models.ForeignKey(default=1, max_length=20, on_delete=django.db.models.deletion.CASCADE, to='clients.agence')),
                ('appelant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='clients.appelant', verbose_name=' celui qui appel ')),
                ('etat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project.etat', verbose_name='etat')),
                ('technicien', models.ManyToManyField(to='ressource.technicien', verbose_name='technicien')),
            ],
            options={
                'verbose_name': 'Tache',
